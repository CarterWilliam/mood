module.exports = function(goLoader) {
  ...
  createAnimation('player', 'player-shoot-south', [ 33, 32 ], 8, 0)
  createAnimation('player', 'player-shoot-south-west', [ 35, 34 ], 8, 0)
  createAnimation('player', 'player-shoot-west', [ 37, 36 ], 8, 0)
  createAnimation('player', 'player-shoot-north-west', [ 39, 38 ], 8, 0)
  createAnimation('player', 'player-shoot-north', [ 41, 40 ], 8, 0)
  createAnimation('player', 'player-shoot-north-east', [ 43, 42 ], 8, 0)
  createAnimation('player', 'player-shoot-east', [ 45, 44 ], 8, 0)
